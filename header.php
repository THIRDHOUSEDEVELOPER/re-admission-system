...
<html lang="en">
  ...
  <head>
    ...
    <title>SB STUDENT INFORMATION</title>
       ...
       <!--<li class="nav-item dropdown">
        ...
        <li class="nav-item">
          <a class="nav-link" href="section.php">
            ...
            <span style="text-shadow: 0px 1px 5px black;">STUDENTS PROFILES</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="schedule.php">
            <i class="fas fa-fw fa-users  "></i>
            <span style="text-shadow: 0px 1px 5px black;">VIEW APPLICATIONS</span></a>
        </li>
      </ul>
